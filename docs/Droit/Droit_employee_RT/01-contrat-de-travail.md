...
1. **Une prestation de travail** — le salarié fournit un travail.
2. **Une rémunération** — en contrepartie, il est payé.
3. **Un lien de subordination** — il travaille sous l'autorité de l'employeur, qui lui donne des directives, en contrôle l'exécution et peut sanctionner. C'est le critère décisif : c'est lui qui distingue le salarié de l'indépendant.
