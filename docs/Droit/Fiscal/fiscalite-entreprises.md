...
:::note Chiffres 2026
Comme pour les particuliers, les taux et seuils **changent chaque année** (loi de finances). Les valeurs ci-dessous sont celles de **2026**. Vérifie toujours sur **impots.gouv.fr** ou **service-public.fr (Entreprendre)** avant toute décision.
:::
